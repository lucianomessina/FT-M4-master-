...
create table Movies (
   ...
   nombre type TEXT NOT NULL default value NULL,
   anio type INTEGER default value NULL,
   rank type REAL default value NULL
);

INSERT INTO Movies (id, nombre, anio, rank)
VALUES (1,'Rapidos y Furiosos', '2010', 5);
INSERT INTO Movies (id, nombre, anio, rank)
VALUES (2,'Diario de una pasion', '2004', 9);
INSERT INTO Movies (id, nombre, anio, rank)
VALUES (3,'Hasta el ultimo hombre', '2018', 10);
INSERT INTO Movies (id, nombre, anio, rank)
VALUES (4,'La isla siniesta', '2009', 10);
...
VALUES (1,'Leonardo', 'DiCaprio', 'Masculino');
INSERT INTO Actors (id, first_name, last_name, gender)
VALUES (2,'Paul', 'Walker', 'Masculino');
INSERT INTO Actors (id, first_name, last_name, gender)
VALUES (3,'Ryan', 'Gosling', 'Masculino');
INSERT INTO Actors (id, first_name, last_name, gender)
VALUES (4,'Emma', 'Stones', 'Femenino');
...
INSERT INTO Roles (actor_id, movie_id, role_name)
VALUES (3,2,'Principal');
INSERT INTO Roles (actor_id, movie_id, role_name)
VALUES (4,3,'Secundary');
